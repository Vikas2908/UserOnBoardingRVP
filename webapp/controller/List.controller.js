sap.ui.define([
    ...
    return BaseController.extend("cis.useronboardingrvp.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("SupplierID", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "cis.useronboardingrvp.view.ViewSettingsDialog",
                    controller: this
