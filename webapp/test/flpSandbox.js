		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RVP-User On Boarding ",
									"targetURL": "#cisuseronboardingrvp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cisuseronboardingrvp-display": {
								"semanticObject": "cisuseronboardingrvp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cis.useronboardingrvp",
									"url": sap.ui.require.toUrl("cis/useronboardingrvp")
								}
							}
						}
					}
